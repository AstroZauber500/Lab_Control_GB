...
Eric Castro Ampere\IEEEauthorrefmark{1},
Esteban Segura Tesla\IEEEauthorrefmark{1} y 
Daniel Chavarria Rutherford\IEEEauthorrefmark{1}}
\vspace{2mm}
\IEEEauthorblockA{\IEEEauthorrefmark{1}Escuela de Ingeniería Electrónica,
Instituto Tecnológico de Costa Rica (ITCR), 30101 Cartago, Costa Rica, \\ \{ecastro, 	essegura, 	dachavarria\}@gmail.com}}
