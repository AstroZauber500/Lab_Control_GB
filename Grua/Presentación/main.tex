...
\usepackage{amsmath}
\usepackage{mathtools} % Añadido para mejorar las ecuaciones con \split y \underbrace
\usepackage{xcolor}
\usepackage{colortbl}
\usepackage{array}
\usepackage{tikz}
...
\begin{columns}[T]
  ...
  \begin{block}{Criterios de selección de polos}
    \scriptsize
    \begin{itemize}
...
\begin{frame}{Pole Placement — Posición del carro: Simulación vs.\ Experimento}
\begin{columns}[T]
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.95\linewidth]{Figures/grafica_carrito_pole_S.png}
    \caption{Respuesta de simulación de posición usando PP.}
    \label{fig:pp_pos_sim}
  \end{figure}
  \vspace{-4pt}
  \begin{table}
    \centering
    \caption{Métricas de posición de la simulación con PP.}
    \label{tab:kpi_pp_pos_sim}
    \scriptsize
    \begin{tabular}{lc}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.95\linewidth]{Figures/grafica_carrito_polos.png}
    \caption{Respuesta experimental de posición usando PP.}
    \label{fig:pp_pos_exp}
  \end{figure}
  \vspace{-4pt}
  \begin{table}
    \centering
    \caption{Métricas de posición del experimento con PP.}
    \label{tab:kpi_pp_pos_exp}
    \scriptsize
    \begin{tabular}{lc}
      \toprule Métrica & Valor \\ \midrule
      $t_s$ (s)  & $5.16$ \\
...
%─────────────────────────────────────────────────────────────────────────────
\begin{frame}{Pole Placement — Ángulo del péndulo: Simulación vs.\ Experimento}
\begin{columns}[T]
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.95\linewidth]{Figures/grafica_carrito_angle_S.png}
    \caption{Respuesta de simulación de ángulo usando PP.}
    \label{fig:pp_angle_sim}
  \end{figure}
  \vspace{-4pt}
  \begin{table}
    \centering
    \caption{Métricas de ángulo de la simulación con PP.}
    \label{tab:kpi_pp_angle_sim}
    \scriptsize
    \begin{tabular}{lc}
      \toprule Métrica & Valor \\ \midrule
      $e_{ss}$ (rad)      & 0 \\
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.95\linewidth]{Figures/grafica_angulo_polos.png}
    \caption{Respuesta experimental de ángulo usando PP.}
    \label{fig:pp_angle_exp}
  \end{figure}
  \vspace{-4pt}
  \begin{table}
    \centering
    \caption{Métricas de ángulo del experimento con PP.}
    \label{tab:kpi_pp_angle_exp}
    \scriptsize
    \begin{tabular}{lc}
      \toprule Métrica & Valor \\ \midrule
      $e_{ss}$ (rad)      & 0.20 \\
      Undershoot (rad)    & $-$0.152 \\
      \bottomrule
    \end{tabular}
  \end{table}
...
\begin{frame}{LQR — Posición del carro: Simulación vs.\ Experimento}
\begin{columns}[T]
...
\begin{table}
    ...
    \begin{tabular}{llcccc}
      ...
      \hline
      \multirow{2}{*}{Pole Placement} & Sim. & 4.4995 & 2.4194 & 0 & Atenuada \\
                                      & Exp. & 5.16   & 3.6    & 0 & Atenuada \\
      \hline
      \rowcolor{rowsim}
                                      & Sim. & 4.701  & 0.601  & 0 & Atenuada \\
      \rowcolor{rowsim}
      \multirow{-2}{*}{LQR}           & Exp. & 5.25   & 0      & 0 & Atenuada \\
      \hline
    \end{tabular}
  \end{table}
  ...
  \begin{columns}[T]
    ...
    \column{0.48\textwidth}
    \begin{block}{Ventajas y limitations}
      \scriptsize
      \centering
      \vspace{4pt}
