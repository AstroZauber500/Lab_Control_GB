...
\midrule
Simulación & 5.01 s & 3.04$\%$ & No \\
Experimental & 5 s & 2.7$\%$ &  Sí \\
\bottomrule
\end{tabular}
\end{frame}
...
\centering
\includegraphics[width=0.8\linewidth]{Figures/experimental_ipd.png}
\end{frame}
...
Condición & $t_s$ & $M_p$ & Cumple \\
\midrule
Simulación & 3.9 s & 1.3 $\%$ & Sí \\
Experimental & 4.94 s & 2.7$\%$ & Sí \\
\bottomrule
\end{tabular}
\end{frame}
