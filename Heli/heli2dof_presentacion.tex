...
\begin{columns}[T]
  ...
  \begin{center}
    \fbox{\parbox{0.88\linewidth}{\centering\vspace{1.8cm}
    {\scriptsize [Figura: Respuesta pitch PP experimental]}\vspace{1.8cm}}}
  \end{center}
  \vspace{-4pt}
  \begin{table}
    \centering\scriptsize
...
\begin{columns}[T]
  ...
  \begin{center}
    \fbox{\parbox{0.88\linewidth}{\centering\vspace{1.8cm}
    {\scriptsize [Figura: Señal Yaw PP experimental]}\vspace{1.8cm}}}
  \end{center}
  \vspace{-4pt}
  \begin{table}
    \centering\scriptsize
  ...
  \begin{center}
    \fbox{\parbox{0.88\linewidth}{\centering\vspace{1.8cm}
    {\scriptsize [Figura: Perturbación PP experimental]}\vspace{1.8cm}}}
  \end{center}
  \vspace{-4pt}
  \begin{table}
    \centering\scriptsize
...
\begin{columns}[T]
  ...
  \begin{center}
    \fbox{\parbox{0.88\linewidth}{\centering\vspace{1.8cm}
    {\scriptsize [Figura: Respuesta pitch LQR experimental]}\vspace{1.8cm}}}
  \end{center}
  \vspace{-4pt}
  \begin{table}
    \centering\scriptsize
...
\begin{columns}[T]
  ...
  \begin{center}
    \fbox{\parbox{0.88\linewidth}{\centering\vspace{1.8cm}
    {\scriptsize [Figura: Señal Yaw LQR experimental]}\vspace{1.8cm}}}
  \end{center}
  \vspace{-4pt}
  \begin{table}
    \centering\scriptsize
  ...
  \begin{center}
    \fbox{\parbox{0.88\linewidth}{\centering\vspace{1.8cm}
    {\scriptsize [Figura: Perturbación LQR experimental]}\vspace{1.8cm}}}
  \end{center}
  \vspace{-4pt}
  \begin{table}
    \centering\scriptsize
